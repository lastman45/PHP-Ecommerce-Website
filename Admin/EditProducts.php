        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <select name="product_category" class="form-select">
                ...
                while ($row_all_category = mysqli_fetch_assoc($result_all_category)) {
                    $row_all_category = mysqli_fetch_assoc($result_all_category);
                    $category_title = $row_all_category['category_title'];
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <select name="product_brands" class="form-select">
                ...
                while ($row_all_brands = mysqli_fetch_assoc($result_all_brands)) {
                    $row_all_brands = mysqli_fetch_assoc($result_all_brands);
